...
def yellow_handle_movement(keys_pressed,yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0:   #Up
            yellow.y -= VEL
            # yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y + VEL+SPACESHIP_HEIGHT < HIGHT - 15:   #Down
            yellow.y+= VEL
            # yellow.y -= VEL
...
def red_handle_movement(keys_pressed,red):
    ...
    if keys_pressed[pygame.K_UP]and red.y - VEL > 0:   #Up
            red.y -= VEL
            # yellow.y -= VEL
    if keys_pressed[pygame.K_DOWN]and red.y + VEL+SPACESHIP_HEIGHT < HIGHT - 15:   #Down
            red.y+= VEL
            # yellow.y -= VEL
...
def draw_winner(text):
      ...
      SCREEN.blit(draw_text,(WIDTH/2 - draw_text.get_width()/2,HIGHT/2 - draw_text.get_height()/2 ))
